...
class Cosmology
{
    public:
        ...
        Cosmology(double HubbleParam, double Omega, double OmegaLambda, double MNu, bool InvertedHierarchy, bool NoRadiation): HubbleParam(HubbleParam), Omega(Omega), OmegaLambda(OmegaLambda), MNu(MNu), InvertedHierarchy(InvertedHierarchy), NoRadiation(NoRadiation)
        {}
